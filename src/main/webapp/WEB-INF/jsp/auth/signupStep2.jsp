...
<body>
    ...
    <main id="content" class="memJoinContent">
        ...
        <ul class="stepWrap clearFix">
            ...
            <li class="current"><b>STEP 02</b>약관동의/본인인증</li>
            <li><b>STEP 03</b>회원정보</li>
            <li><b>STEP 04</b>가입완료</li>
        </ul>
        <div class="joinStepDesc">
            <div class="contTextWrap">
                <em>E-healthcare 홈페이지는 이용을 원하는 모든 분들께 무료로 제공되고 있습니다.</em>
            </div>
            <p>단, 온라인 진료 서비스 등 일부 컨텐츠는 E-healthcare 온라인 회원에게만 제공하고 있습니다.</p>
            <p>E-healthcare의 온라인 회원정책은 <em class="colorPoint">진료회원과 전문의료진</em>으로 나뉘어 서비스 되고 있습니다.<br>진료회원으로 가입하는 경우, 인터넷 진료예약 등 보다 다양한 서비스를 이용할 수 있습니다.</p>
            <p>전문의료진으로 가입하면 의사면허를 인증하여 진료회원과의 진료를 진행할 수 있습니다.</p>
        ...
        <form>
            <fieldset>
                ...
                <div class="boxTypeGray checkAllBox">
                    <input type="checkbox" id="checkbox00" class="feFoCheckAll"  data-fe-group="group1" title="이용약관, 개인정보처리방침 모두 동의">
                ...
                <div class="persInforWrap">
                    ...
                    <div class="checkWrap">
                        <input id="checkbox01" type="checkbox" data-fe-group="group1" title="이용약관 동의">
                    ...
                    <div class="scrollBox">
                        <div class="innerScroll">
                            ...
                            <p class="privacyIntro">서울대학교병원은 개인정보 보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.<br>
                                ...
                                본 방침은<span class="b">&nbsp;2021년 12월 7일</span>부터 새롭게 시행됩니다.&nbsp;</p>
                            <div class="contTitleWrap">
                                ...
                                <table status="default" class="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p style="text-align: left;">: 사망장소, 사망시간, 다태상태, 출생순위, 분만방법, 임신주수, 출생시 체중, 분만시간, 출생시 두위, 출생시 신장, 아프가점수, 산전관리, 직전임신결과, 임신&middot;분만 기간 중 질환, 혈압, 체중, 신장, 흡연상태, 혼인상태, 교육수준, 직업, 국적, 사망원인, 합병증, 과거질환, 타기관 의뢰여부, 수술여부, 수혈여부, 임신 횟수, 직전임신 종결일자, 임신의 결과, 성별, 총사산아수</p></td>
                                        <td>
                                            <p>영구</p></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p style="text-align: left;">진료의뢰&middot;회송 중계시스템을 통하여 전자적으로 회송서를 수신하는 요양기관, 보건복지부, 건강보험심사평가원</p></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p style="text-align: left;">- 성범죄 : 「아동&middot;청소년의 성보호에 관한 법률」 제56조 및 동법 시행령 제25조</p>
                            ...
                            <div class="contTextWrap"><strong>가. 홈페이지 회원가입 및 관리</strong></div>
                            <ul class="listType01">
                                <li class="b">필수항목: 로그인ID, 비밀번호, 이름, 성별, 자택주소, 이메일, 생년월일, 국적,&nbsp;<br> 진료회원인 경우:&nbsp; 환자등록번호(또는 주민등록번호)&nbsp;</li>
                                <li class="b">선택항목: 자택전화번호, 휴대전화번호 (둘 중 하나는 필수), 식별정보(IPin, 휴대전화 본인확인)</li>
                                <li class="b">14세미만 추가 필수항목: 법적대리인 이름, 관계, 식별정보</li>
                            </ul>
                            <div class="contTextWrap"><strong>나. 병원정보시스템</strong></div>
                            <ul class="listType01">
                                <li class="b">필수항목: 성명, 주소, 연락처, 생년월일, 고유식별번호 (주민등록번호, 외국인번호), 진료정보</li>
                                <li class="b"><span style="font-size: 10pt;">의학정보/홍보자료 제공 동의 시</span>: 성명, 주소, 연락처 활용</li>
                            </ul>
                            ...
                            <ul class="listType01">
                                <li class="b">필수항목(회원가입을 위해 필요한 개인정보)<br>
                                    ...
                                    <br></li>
                                <li class="b">선택항목(각 서비스 이용을 위해 필요한 정보)<br>
                            ...
                            <div class="contTextWrap"><strong>아.&nbsp;서울대학교병원 개인정보파일 현황</strong></div>
                            <ul class="listType01">
                                <li class="b"><span>개인정보보호 종합지원포털(</span><a href="http://www.privacy.go.kr" target="_blank" title="새 창으로 이동"><span>www.privacy.go.kr</span></a><span>) &rarr;민원마당&rarr; 개인정보의 열람 등 요구 &rarr; 개인정보파일 목록 검색 &rarr; 기관명에 &ldquo;서울대학교병원&rdquo; 입력 후 조회</span></li>
                            </ul>
                            <div class="contTitleWrap">
                            ...
                            <p><strong><br>
                                나. 정보주체께서는 ㉮항의 열람청구 접수/처리부서 이외에, 개인정보보호위원회의 &lsquo;개인정보보호 종합지원 포털&rsquo; 웹사이트(<a href="//www.privacy.go.kr" target="_blank">www.privacy.go.kr</a>)를 통하여서도 개인정보 열람청구를 하실 수 있습니다.</strong><strong>다. 열람 정정요구시 본인 또는 제3자를 현저하게 해할 우려가 있거나, 서비스 제공자의 업무에 현저한 지장을 미칠 경우, 다른 법령에 위반하는 경우가 있을 경우 등의 사유로 열람 및 정정요구를 거부 할 수 있습니다</strong></p>
                            <p><strong>개인정보보호위원회&nbsp;개인정보보호 종합지원 포털 &rarr; 개인정보 민원 &rarr; 개인정보 열람등 요구 (본인확인을 위하여 아이핀(I-PIN)이 있어야 함)</strong></p>
                            <div class="contTitleWrap">
                            ...
                            <ul class="listType01">
                                <li class="b">2008년 4월 16일(<a href="//www.snuh.org/footer/privacy/p2.do" target="_blank">보기</a>)</li>
                                <li class="b">2009년 6월 3일(<a href="//www.snuh.org/footer/privacy/p3.do" target="_blank">보기</a>)</li>
                                <li class="b">2011년 12월 6일(<a href="//www.snuh.org/footer/privacy/p4.do" target="_blank">보기</a>)</li>
                                <li class="b">2012년 3월 1일(<a href="//www.snuh.org/footer/privacy/p5.do" target="_blank">보기</a>)</li>
                                <li class="b">2012년 7월 10일(<a href="//www.snuh.org/footer/privacy/p6.do" target="_blank">보기</a>)</li>
                                <li class="b">2012년 11월 5일(<a href="//www.snuh.org/footer/privacy/p7.do" target="_blank">보기</a>)</li>
                                <li class="b">2014년 8월 7일(<a href="//www.snuh.org/footer/privacy/p8.do" target="_blank">보기</a>)</li>
                                <li class="b">2015년 2월 7일(<a href="//www.snuh.org/footer/privacy/p9.do" target="_blank">보기</a>)</li>
                                <li class="b">2016년 4월 11일(<a href="//www.snuh.org/footer/privacy/p10.do" target="_blank">보기</a>)</li>
                                <li class="b">2016년 12월 19일(<a href="//www.snuh.org/footer/privacy/p11.do" target="_blank">보기</a>)</li>
                                <li class="b">2017년 9월 18일(<a href="//www.snuh.org/footer/privacy/p12.do" target="_blank">보기</a>)</li>
                                <li class="b">2017년 10월 15일(<a href="//www.snuh.org/footer/privacy/p13.do" target="_blank">보기</a>)</li>
                                <li class="b">2018년 3월 7일(<a href="//www.snuh.org/footer/privacy/p14.do" target="_blank">보기</a>)</li>
                                <li class="b">2018년 4월 20일(<a href="//www.snuh.org/content/M006008003.do" target="_blank">보기</a>)</li>
                                <li class="b">2019년 3월 27일(<a href="//www.snuh.org/content/M006008048.do" target="_blank">보기</a>)</li>
                                <li class="b">2019년 5월 27일(<a href="//www.snuh.org/content/M006008006.do" target="_blank">보기</a>)</li>
                                <li class="b">2019년 6월 30일(<a href="//www.snuh.org/content/M006008007.do" target="_blank">보기</a>)</li>
                                <li class="b">2019년 9월 30일(<a href="//www.snuh.org/content/M006008008.do" target="_blank">보기</a>)</li>
                                <li class="b">2020년 3월 31일(<a href="//www.snuh.org/content/M006008009.do" target="_blank">보기</a>)</li>
                                <li class="b">2020년 6월 30일(<a href="//www.snuh.org/content/M006008010.do" target="_blank" title="개인정보처리방침 10일 27일 이전 사항">보기</a>)</li>
                                <li class="b">2020년 12월 10일(<a href="//www.snuh.org/content/M006008011.do" target="_blank" title="개인정보처리방침 10일 27일 이전 사항">보기</a>)</li>
                                <li class="b">2021년 7월 9일(<a href="http://www.snuh.org/content/M006008012.do" target="_blank" title="개인정보처리방침 7월 9일 이전 사항">보기</a>)</li>
                                <li class="b">2021년 8월 25일(<a href="//www.snuh.org/content/M006008013.do" target="_blank" title="개인정보처리방침 8월 25일 이전 사항">보기</a>)</li>
                                <li class="">2021년 12월 7일자로 수정되어 시행하고 있습니다.&nbsp;</li>
                            </ul>
                            <!-- //layerWrap -->
                        </div>
                    </div>
                    <div class="checkWrap">
                        <input id="checkbox02" type="checkbox" data-fe-group="group1" title="개인정보 수집 동의">
                ...
                <!-- checkAllBox -->
                <div class="boxTypeGray checkAllBox">
                    <input type="checkbox" id="checkbox03" class="feFoCheckAll"  data-fe-group="group1" title="이용약관, 개인정보 처리 방침 모두 동의">
        ...
        <div class="tabTypeCol3 contTabType a">
            <ul class="clearFix" data-pannel="1">


                <li><a href="#contTabType01">본인명의 이메일 인증</a></li>
        ...
        <!-- //tabType -->
                    <div class="boardTypeForm">
                            <table>
                                ...
                                <form action="/mailCheck?email=email" method="GET">
                                    ...
                                    <button class = "sendmsg" >인증번호 보내기</button><br />
                                    <input type="text" name="text" placeholder="인증번호" title="인증번호를 입력해주세요." />
                                    <button class = "msg" >인증번호 확인</button><br />
                                </form>
                    ...
                    <div class="btnWrap">
                        <button type="button" class="btnType03 btnBig" id="hNextBtn" onclick=location.href="/auth/signupStep3">다음단계</button>
                    </div>
