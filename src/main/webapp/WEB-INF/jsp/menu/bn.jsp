...
<div class ="container">
    ...
    <div class = "doctorContainer">
        <div class = "subjectField">
            <span class = "subjectTitle"> 비뇨의학과 </span>
            <span style="color: #157CC0; font-weight: bold;"> | </span>
            <span id = "subjectInfo">가정의학과는 개인과 가족의 건강문제를 지속적이고 포괄적으로 돌보아드리는 과입니다.비뇨의학과는 소변이 생성 저장되고 몸 밖으로 나가는 통로에 있는 콩팥(신장), 요관, 방광, 요도 등 요로계 장기들과 음경, 고환, 정관 및 전립선 등 남성생식과 관련된 장기를 다루는 진료과로서 이들 장기에 발생된 질환들을 진단하고 주로 수술적인 방법으로 치료하고 있는 외과계의 한 분야입니다.<br>
        ...
        <div class = "doctorList">
            ...
            <div class = "doctorContent" id="doc1">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">유탁근</span>
                    <span>의사</span>
                </div>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">종양,여성비뇨기,전립선</span>
                </div>
                <div id = "hospitalName">
                    <span style="color: #145c8b;">노원을지대학교병원</span>
                </div>
            ...
            <div class = "doctorContent" id="doc2">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">전성수</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[비뇨의학과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">전립선암, 로봇수술, PSA</span>
                </div>
                <div id = "hospitalName">
            ...
            <div class = "doctorContent" id="doc3">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">손환철</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[비뇨의학과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;"> 전립선비대증(레이저수술)</span>
                </div>
                <div id = "hospitalName">
                    <span style="color: #145c8b;">서울특별시보라매병원</span>
                </div>
                <div id = "doctorWaiting">
                    <img src="/images/waiting.png">
                    <span>: 1명</span>
            ...
            <div class = "doctorContent" id="doc4">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">주명수</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[비뇨의학과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">배뇨장애,여성요실금,전립선비대증</span>
                </div>
                <div id = "hospitalName">
            ...
            <div class = "doctorContent" id="doc5">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">한상원</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[비뇨의학과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">소아비뇨기기형</span>
                </div>
                <div id = "hospitalName">
