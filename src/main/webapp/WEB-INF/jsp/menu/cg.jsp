...
<div class ="container">
    ...
    <div class = "doctorContainer">
        <div class = "subjectField">
            <span class = "subjectTitle"> 치과 </span>
            <span style="color: #157CC0; font-weight: bold;"> | </span>
            <span id = "subjectInfo">치과는 치아와 잇몸 및 턱, 얼굴에 관련된 다양한 질병을 치료 하는 과입니다.<br>
          전문 진료과가 체계적인 협진체계를 구성하여 더 나은 진료를 환자 중심으로 제공하기 위하여 노력하고 있습니다.
          </span>
        </div>
        ...
        <div class = "doctorList">
            ...
            <div class = "doctorContent" id="doc1">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">오태석</span>
                    <span>의사</span>
                </div>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">신경치료, 미세현미경수술, 치아이식술</span>
                </div>
                <div id = "hospitalName">
            ...
            <div class = "doctorContent" id="doc2">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">박기태</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[치과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">소아청소년 턱교정치료, 예방 및 수복치료</span>
                </div>
                <div id = "hospitalName">
                    <span style="color: #145c8b;">삼성서울병원</span>
                </div>
            ...
            <div class = "doctorContent" id="doc3">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">김정혜</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[치과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">치주조직재생, 심미치주, 임플란트</span>
                </div>
                <div id = "hospitalName">
                    <span style="color: #145c8b;">삼성서울병원</span>
                </div>
            ...
            <div class = "doctorContent" id="doc4">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">계승범</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[치과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">만성 치주염, 치주성형, 임플란트</span>
                </div>
                <div id = "hospitalName">
                    <span style="color: #145c8b;">삼성서울병원</span>
                </div>
