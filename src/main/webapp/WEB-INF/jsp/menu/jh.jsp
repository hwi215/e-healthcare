...
<div class ="container">
    ...
    <div class = "doctorContainer">
        <div class = "subjectField">
            <span class = "subjectTitle"> 정형외과 </span>
            <span style="color: #157CC0; font-weight: bold;"> | </span>
            <span id = "subjectInfo">정형외과는 사지와 척추, 그리고 그 부속기관의 형태와 기능을 내과적, 외과적, 물리적인 방법으로 연구하고 보존하여 회복 발전시키는 분야로 사지골, 관절 및 척추골 등의 골절, 탈구, 인대손상 등 외상에 대한 치료와 관절질환 및 손상으로 인한 재건술, 고관절 및 슬관절의 인공관절 치환술을 실시하고 있습니다.<br>
          </span>
        </div>
        ...
        <div class = "doctorList">
            ...
            <div class = "doctorContent" id="doc1">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">이승준</span>
                    <span>의사</span>
                </div>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">손, 손목 및 팔꿈치관절</span>
                </div>
                <div id = "hospitalName">
            ...
            <div class = "doctorContent" id="doc2">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">송해룡</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[정형외과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">소아정형, 희귀질환, 왜소증</span>
                </div>
                <div id = "hospitalName">
            ...
            <div class = "doctorContent" id="doc3">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">최남홍</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[정형외과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">어깨, 무릎, 최소절개무릎인공관절</span>
                </div>
                <div id = "hospitalName">
            ...
            <div class = "doctorContent" id="doc4">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">심종섭</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[정형외과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">소아정형, 선천성기형, 뇌성마비</span>
                </div>
                <div id = "hospitalName">
            ...
            <div class = "doctorContent" id="doc5">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">박윤수</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[정형외과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">고관절인공관절,엉덩이 관절</span>
                </div>
                <div id = "hospitalName">
                    <span style="color: #145c8b;">삼성서울병원</span>
                </div>
