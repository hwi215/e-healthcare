...
<div class ="container">
    ...
    <div class = "doctorContainer">
        <div class = "subjectField">
            <span class = "subjectTitle"> 산부인과 </span>
            <span style="color: #157CC0; font-weight: bold;"> | </span>
            <span id = "subjectInfo"> 산부인과는 여성의 건강증진을 위한 첨병으로서 교육, 연구 및 진료에 앞장서고 있습니다. 진료에 있어서 임신, 부인과 양성 및 악성 질환, 난임•가임력보존 및 내분비 질환, 비뇨부인과 질환 등 다양한 여성 질환에 대한 최신 진단과 치료를 시행하고 있습니다. <br>
        ...
        <div class = "doctorList">
            ...
            <div class = "doctorContent" id="doc1">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">이보연</span>
                    <span>의사</span>
                </div>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">비정상 출혈, 무월경, 페경기</span>
                </div>
                <div id = "hospitalName">
            ...
            <div class = "doctorContent" id="doc2">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">김재훈</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[산부인과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">자궁경부암, 난소암,자궁내막암</span>
                </div>
                <div id = "hospitalName">
            ...
            <div class = "doctorContent" id="doc3">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">채희동</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[산부인과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">여성불임,골반장기탈출증,방광탈출</span>
                </div>
                <div id = "hospitalName">
            ...
            <div class = "doctorContent" id="doc4">
                ...
                <div id = "doctorName">
                    <span style="color: #157CC0 ">이근영</span>
                    <span>의사</span>
                </div>
                <div id = "doctorSubject">
                    <span>[산부인과]</span>
                ...
                <div id = "doctorField">
                    <span>[진료분야]<br></span>
                    <span style="font-family: NEXON;">산과, 고위험산모, 유전학</span>
                </div>
                <div id = "hospitalName">
                    <span style="color: #145c8b;">한림대학교 강남성심병원</span>
                </div>
                <div id = "doctorWaiting">
                    <img src="/images/waiting.png">
                    <span>: 0명</span>
